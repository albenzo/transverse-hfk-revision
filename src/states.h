...
void copy_lift_state(LiftState *, const LiftState *const,
...
int comp_lift_state(const LiftState, const LiftState,
                    const LiftGrid_t *const G);
...
LiftStateList remove_lift_state(const LiftState, const LiftStateList,
                                const LiftGrid_t *const);
...
LiftStateRBTree copy_lift_tree(LiftStateRBTree, LiftStateRBTree,
                               const LiftGrid_t *const);
void insert_data(LiftStateRBTree *, LiftState, const LiftGrid_t *const);
void insert_tagged_data(LiftStateRBTree *, LiftState, int,
                        const LiftGrid_t *const);
...
LiftStateRBTree find_node(const LiftStateRBTree *const, LiftState,
                          const LiftGrid_t *const);
int get_tag(LiftStateRBTree *, LiftState, const LiftGrid_t *const);
...
int s_get_tag(StateRBTree *, State, const Grid_t *const);
